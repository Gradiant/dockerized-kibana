...
# custom throbber
RUN sed -i 's/Loading Kibana/Loading Gradiant/g' /usr/share/kibana/src/ui/ui_render/views/ui_app.pug
...
RUN sed -i 's/title Kibana/title Grad-mgda/g' /usr/share/kibana/src/ui/ui_render/views/chrome.pug
# custom plugin css
